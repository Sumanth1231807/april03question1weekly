...
def test_program02(setUp):
    ...
    time.sleep(2)
    driver.find_element_by_name("name").send_keys("SUMANTH R")
    time.sleep(1)
    ...
    time.sleep(1)
    driver.find_element_by_xpath("/html/body/div/div/div[2]/form/table/tbody/tr[4]/td[2]/input").send_keys("15.03.2000")
    time.sleep(1)
